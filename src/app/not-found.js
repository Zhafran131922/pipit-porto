  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white flex flex-col items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="relative z-10 max-w-2xl w-full">
        ...
        >
          <div className="relative">
            <input
              ...
              className="w-full bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-full py-4 px-6 pl-14 text-white focus:outline-none focus:border-pink-500 transition-colors"
            />
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-pink-600 to-purple-600 text-white px-4 py-2 rounded-full text-sm flex items-center gap-1"
            >
        ...
        >
          <p>Still lost? Contact support at support@example.com</p>
        </motion.div>
      </div>
